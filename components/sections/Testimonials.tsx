                      ...
                      <div className="card-testimonial background-card">
                        <div className="card-info">
                          ...
                          <p className="text-md-regular neutral-500">
                            Get prompt help when you're in a bind with our
                            reliable roadside support. Whether it’s a flat tire,
                            running out of gas, or anything else, we're here to
                            help.
                          </p>
                        </div>
                    ...
                    <SwiperSlide>
                      <div className="card-testimonial background-card">
                        <div className="card-info">
                          ...
                          <p className="text-md-regular neutral-500">
                            Rent a vehicle that suits your needs and get on the
                            road hassle-free. We offer a variety of cars to fit
                      ...
                      <div className="card-testimonial background-card">
                        <div className="card-info">
                          ...
                          <p className="text-md-regular neutral-500">
                            ...
                            comprehensive vehicle maintenance services. From
                            regular check-ups to repairs, we've got you covered.
                          </p>
                        </div>
                        <div className="card-top pt-40 border-0 mb-0">
                          <div className="card-author">
                    ...
                    <SwiperSlide>
                      <div className="card-testimonial background-card">
                        <div className="card-info">
                          ...
                          <p className="text-md-regular neutral-500">
                            In the unfortunate event of an accident, we're here
                            to assist you with fast and efficient accident
